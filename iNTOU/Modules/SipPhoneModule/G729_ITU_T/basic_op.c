...
/*___________________________________________________________________________
 ...
 |   bit number:                                                             |
 |               round_mac(L_var1) = extract_h(L_add(L_var1,32768))              |
 |                                                                           |
 |   Complexity weight : 1                                                   |
 |                                                                           |
 |   Inputs :                                                                |
...
Word16 round_mac(Word32 L_var1)
  {
   Word16 var_out;
   Word32 L_arrondi;
...
/*___________________________________________________________________________
 ...
 |            mac_r(L_var3,var1,var2) = round_mac(L_mac(Lvar3,var1,var2))        |
 |                                                                           |
 |   Complexity weight : 2                                                   |
 |                                                                           |
 |   Inputs :                                                                |
...
/*___________________________________________________________________________
 ...
 |            msu_r(L_var3,var1,var2) = round_mac(L_msu(Lvar3,var1,var2))        |
 |                                                                           |
 |   Complexity weight : 2                                                   |
 |                                                                           |
 |   Inputs :                                                                |
