...
)
{
 ...
 /* Scaling h[] for maximum precision */
  ...
  rri0i2 = rri0i1 + MSIZE2;
  rri0i3 = rri0i2 + MSIZE2;
  rri0i4 = rri0i3 + MSIZE2;
  rri1i2 = rri0i4 + MSIZE2;
  rri1i3 = rri1i2 + MSIZE2;
  rri1i4 = rri1i3 + MSIZE2;
  rri2i3 = rri1i4 + MSIZE2;
  rri2i4 = rri2i3 + MSIZE2;
